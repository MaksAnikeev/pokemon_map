...
Сама программа была написана и она работала через json файл базы данных. Я сам писал к ней модельки, админку, делал БД через админку и изменял вьюшки с файла json на созданную в админке БД
